...
function SvgNodejs(props) {
  return (
    <svg viewBox="0 0 442.4 270.9" {...props}>
      <defs>
        <linearGradient
          id="nodejs_svg__b"
          x1={180.7}
        ...
        >
          ...
          <stop offset={0.3} stopColor="#3f8b3d" />
          <stop offset={0.6} stopColor="#3e9637" />
          <stop offset={0.9} stopColor="#3da92e" />
        ...
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset={0.1} stopColor="#3f873f" />
          <stop offset={0.4} stopColor="#529f44" />
          <stop offset={0.7} stopColor="#63b649" />
          <stop offset={0.9} stopColor="#6abf4b" />
        </linearGradient>
        <linearGradient
          id="nodejs_svg__a"
          x1={114.6}
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop offset={0.1} stopColor="#6abf4b" />
          <stop offset={0.3} stopColor="#63b649" />
          <stop offset={0.6} stopColor="#529f44" />
          <stop offset={0.9} stopColor="#3f873f" />
        </linearGradient>
        <linearGradient
          id="nodejs_svg__e"
          x1={114.9}
        ...
        <linearGradient
          ...
          x2={166.4}
          y2={201}
          xlinkHref="#nodejs_svg__b"
        />
        <clipPath id="nodejs_svg__c" transform="translate(-.3)">
          <path
      ...
      <g clipPath="url(#nodejs_svg__c)">
        ...
        <path
          ...
          fill="none"
        />
        <path fill="url(#nodejs_svg__a)" d="M159.3 53.6l-.6.4h.8l-.2-.4z" />
        <path
        ...
        />
        <path fill="url(#nodejs_svg__f)" d="M212 143.6l-.3-.5v.7l.3-.2z" />
        <path
